          ...
          <section>
            ...
            <div className="form-box">
              <div className="button-box">
                <div id="btn" />
                <button type="button" className="toggle-btn" onclick="patient()">Patient</button>
                <button type="button" className="toggle-btn" onclick="doctor()">Doctor</button>
              </div>
              <div id="heading">
                <p>MediCare</p>
              </div>
              <form id="patient" className="input-group">
                <input type="email" className="input-field" placeholder="Email ID" required />
                <input type="password" className="input-field" placeholder="Password" required />
               <Link to='/patientd'> <button type="submit" className="submit-btn">Welcome</button> </Link>
              </form>
              <form id="doctor" className="input-group">
                <input type="email" className="input-field" placeholder="Email ID" required />
                <input type="password" className="input-field" placeholder="Password" required />
               <Link to='/patientd'> <button type="submit" className="submit-btn"> Welcome </button> </Link>
              </form>
