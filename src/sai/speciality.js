    ...
    <div>
      <section>
        ...
        <div className="care">
          ...
          <img src="doc.png" alt=""/> */}
          {/* </div> */}
          <a href='/book'><button className="button1">Book Appointment</button></a>
          <a href='/video'><button className="button2">Video Consultation</button></a>
          <a href='/paymenthome'><button className="button3">Payments</button></a>
